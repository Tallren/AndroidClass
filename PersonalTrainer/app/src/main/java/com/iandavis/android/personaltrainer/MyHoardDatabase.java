...
public class MyHoardDatabase {
    ...
    private Cursor getAccessibleHoard() {
        ...
        Cursor cursor = db.query(HoardDBOpenHelper.CUSTOMERS_DATABASE_TABLE,
    ...
    public void addNewHoard(String hoardName, float hoardValue, boolean hoardAccessible) {
        ...
        SQLiteDatabase db = hoardDBOpenHelper.getWritableDatabase();
        db.insert(HoardDBOpenHelper.CUSTOMERS_DATABASE_TABLE, null, newValues);
    }
    ...
    public void updateHoardValue(int hoardId, float newHoardValue) {
        ...
        SQLiteDatabase db = hoardDBOpenHelper.getWritableDatabase();
        db.update(HoardDBOpenHelper.CUSTOMERS_DATABASE_TABLE, updatedValues,
                where, whereArgs);
    }
    ...
    public void deleteEmptyHoards() {
        ...
        SQLiteDatabase db = hoardDBOpenHelper.getWritableDatabase();
        db.delete(HoardDBOpenHelper.CUSTOMERS_DATABASE_TABLE, where, whereArgs);
    }
    ...
    private static class HoardDBOpenHelper extends SQLiteOpenHelper {
        ...
        private static final String CUSTOMERS_DATABASE_TABLE = "Customers";
        private static final int DATABASE_VERSION = 1;

        // SQL Statement to create a new database.
        private static final String DATABASE_CREATE = "create table " +
                CUSTOMERS_DATABASE_TABLE + " (" + KEY_ID +
